      ...
      <div className="grid grid-flow-col gap-6 mb-6">
        ...
        <div>
          ...
          <select
            ...
            className={formData.trapper ? "text-primaryGray" : "text-gray-400"}
        ...
        <div>
          ...
          <select
            ...
            className={formData.service ? "text-primaryGray" : "text-gray-400"}
            onChange={handleFieldChange}
          >
            <option value="" disabled hidden>
              Select a service
        ...
        <div className="w-2/5 flex gap-6">
          ...
          <div className="w-full">
            ...
            >
              ...
              {estimatedAges.map((estAge, index) => (
                <option key={index} value={estAge} className="text-primaryGray">
                  {estAge}
                </option>
              ))}
            </select>
          ...
          <div className="flex w-full gap-6 mb-6">
            ...
            <div className="min-w-24">
              ...
              <select
                id="sex"
                name="sex"
                className={formData.sex ? "text-primaryGray" : "text-gray-400"}
                value={formData.sex}
                onChange={handleFieldChange}
              >
                <option value="" disabled hidden>
      ...
      <div className="flex gap-6 justify-between">
        ...
        <div className="flex-grow">
          ...
          <select
            ...
            name="outcome"
            defaultValue=""
            className={formData.outcome ? "text-primaryGray" : "text-gray-400"}
            onChange={handleFieldChange}
          >
            <option value="" disabled hidden>
              Select an outcome
            </option>
            {outcomes.map((currOutcome, index) => (
              <option
                key={index}
                value={currOutcome}
                className="text-primaryGray"
